...
const HdiLogo = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="72px" height="29px" viewBox="0 0 72 29" version="1.1" xmlns="http://www.w3.org/2000/svg">
      <title>500x200</title>
      <desc>Created with Sketch.</desc>
      <g id="04-Seitenrahmen" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g id="Desktop-1440px---Privatkunden-v1" transform="translate(-180.000000, -62.000000)" fillRule="nonzero">
              <g id="Group-5">
